  ...
  return (
    <motion.div
      ...
      style={{
        background:
          rank === 0
            ? "linear-gradient(135deg, #1a1000 0%, #332200 50%, #1a1000 100%)"
            : "linear-gradient(135deg, #0f2e1a 0%, #1a4d2e 100%)",
      }}
    >
      {/* Rank Badge */}
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(90deg, transparent, transparent 20px, #10b981 20px, #10b981 22px)",
          }}
        />
      </div>
          ...
          <div className="text-right">
            <motion.div
              className={`text-4xl font-black ${
                rank === 0 ? "text-yellow-400" : "text-cyan-400"
              }`}
    ...
    >
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <motion.div
            className={`flex-1 ${
              winner === "team2" ? "text-yellow-400" : "text-white"
            }`}
            whileHover={{ x: 5 }}
          >
...
export default function FieldHockeySchedule() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-green-950 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            Field Hockey Championship 2024
          </p>
        </motion.div>
        ...
        <div className="flex justify-center gap-3 mb-8">
          {[
            ...
            { id: "players", icon: Target, label: "Top Players" },
            ...
            <motion.button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm uppercase tracking-wider transition-all ${
                activeSection === section.id
                  ? "bg-gradient-to-r from-cyan-600 to-green-600 text-white shadow-lg shadow-cyan-500/50"
          ...
          {activeSection === "matches" && (
            ...
            >
              ...
              <div className="relative mb-8">
                <div className="flex justify-center gap-2 md:gap-4 bg-gray-900/50 backdrop-blur-sm p-2 rounded-2xl border border-gray-800">
                  {tabs.map((tab) => (
                    <motion.button
                      key={tab}
                    ...
                    >
                      {activeTab === tab && (
                        <motion.div
                          layoutId="activeTab"
                          className="absolute inset-0 bg-gradient-to-r from-cyan-600 to-green-600 rounded-xl"
                          style={{
