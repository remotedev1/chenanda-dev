  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-slate-50 dark:bg-slate-800 p-6 rounded-lg text-slate-600 dark:text-slate-300">
          <DialogHeader>
            <DialogTitle className="text-slate-800 dark:text-slate-100">Add New Sponsor</DialogTitle>
            <DialogDescription className="text-slate-600 dark:text-slate-400">Fill in the sponsor details below</DialogDescription>
          </DialogHeader>
          <SponsorForm
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          ...
          <DialogHeader>
            <DialogTitle className="text-slate-800 dark:text-slate-100">Edit Sponsor</DialogTitle>
            <DialogDescription className="text-slate-600 dark:text-slate-400">Update the sponsor details below</DialogDescription>
          </DialogHeader>
          <SponsorForm
